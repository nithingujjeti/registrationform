        ...
        <div className="color">
          <div className="card-container">
            ...
            <p className="des">
              ...
              visitors to browse, select, and buy art directly through the
              website
            </p>
          </div>
          <div className="card-container">
            ...
            <p className="des">
              Highlight the option for customers to request and commission
              custom artwork, with details on the process and pricing.
            </p>
          </div>
          <div className="card-container">
            <h1>Art Rental</h1>
